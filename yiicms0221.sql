...
insert  into `ad`(`id`,`title`,`type`,`category_id`,`image`,`link`,`created_at`,`updated_at`) values (1,'百度',101,0,'/uploads/ad-img/img_58500a3e1b241.jpg','http://www.baidu.com',1481640510,1481640673),(2,'腾讯',101,0,'/uploads/ad-img/img_58500a67014d3.jpg','http://www.qq.com',1481640551,1481640751),(3,'网易',101,0,'/uploads/ad-img/img_58500a8b4fb51.png','http://www.163.com',1481640587,1481640587);
...
insert  into `admin_menu`(`id`,`name`,`parent`,`route`,`order`,`data`) values (1,'产品管理',NULL,'/backend/products/index',0,'{\"icon\" :\"fa fa-th\"}'),(2,'产品分类',1,'/backend/category/index?type=1',1,NULL),(3,'产品列表',1,'/backend/products/index',0,NULL),(4,'新闻管理',NULL,'/backend/news/index',1,'{\"icon\":\"fa fa-newspaper-o\"}'),(5,'新闻列表',4,'/backend/news/index',0,NULL),(6,'新闻分类',4,'/backend/category/index?type=2',1,NULL),(7,'下载管理',NULL,'/backend/downloads/index',2,'{\"icon\":\"fa fa-download\"}'),(8,'下载列表',7,'/backend/downloads/index',0,NULL),(9,'下载分类',7,'/backend/category/index?type=3',1,NULL),(10,'照片管理',NULL,'/backend/photos/index',4,'{\"icon\":\"fa fa-picture-o\"}'),(11,'相册列表',10,'/backend/photos/index',0,NULL),(12,'相册分类',10,'/backend/category/index?type=4',1,NULL),(13,'用户反馈',NULL,'/backend/feedback/index',5,'{\"icon\":\"fa fa-commenting\"}'),(14,'网站配置',NULL,'/backend/config/index',6,'{\"icon\":\"fa fa-cog\"}'),(15,'基础配置',14,'/backend/config/base-config',1,NULL),(16,'其他配置',14,'/backend/config/index',2,NULL),(17,'轮播图片',14,'/backend/ad/index',3,NULL),(18,'后台配置',NULL,'/backend/rbac/route/index',7,'{\"icon\":\"fa fa-bars\"}'),(19,'管理员列表',18,'/backend/admin-user/index',1,NULL),(20,'权限配置',18,'/backend/rbac/assignment/index',2,NULL),(21,'角色列表',18,'/backend/rbac/role/index',3,NULL),(22,'权限列表',18,'/backend/rbac/permission/index',4,NULL),(23,'规则列表',18,'/backend/rbac/rule/index',5,NULL),(24,'路由列表',18,'/backend/rbac/route/index',5,NULL),(25,'后台菜单',18,'/backend/rbac/menu/index',7,NULL),(26,'开发工具',NULL,'/gii/default/index',8,'{\"icon\":\"fa fa-share\"}'),(27,'gii',26,'/gii/default/index',2,NULL),(28,'debug',26,'/debug/default/index',1,NULL),(29,'模板主题配置',14,'/backend/config/view-config',2,NULL),(30,'页面管理',14,'/backend/page/index',7,NULL);
...
insert  into `admin_user`(`id`,`username`,`auth_key`,`password_hash`,`password_reset_token`,`email`,`status`,`access_token`,`created_at`,`updated_at`) values (1,'admin','','21232f297a57a5a743894a0e4a801fc3',NULL,'739800600@qq.com',10,'',0,1482893156),(4,'demo','','fe01ce2a7fbac8fafaed7c982a04e229',NULL,'demo@demo.com',10,'',1481431804,1481431804);
...
insert  into `auth_assignment`(`item_name`,`user_id`,`created_at`) values ('Administrator','1',1482897657),('AdministratorAccess','1',1482897661),('Visitor','4',1482897661),('VisitorAccess','4',1482897661);
...
insert  into `auth_item`(`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) values ('/backend/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/ad/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/admin-user/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/index',2,NULL,NULL,NULL,1482977677,1482977677),('/backend/category/index?type=1',2,NULL,NULL,NULL,1482977712,1482977712),('/backend/category/index?type=2',2,NULL,NULL,NULL,1482977717,1482977717),('/backend/category/index?type=3',2,NULL,NULL,NULL,1482977721,1482977721),('/backend/category/index?type=4',2,NULL,NULL,NULL,1482977728,1482977728),('/backend/category/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/category/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/base-config',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/config/view-config',2,NULL,NULL,NULL,1483066838,1483066838),('/backend/default/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/default/edit-password',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/default/error',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/default/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/default/login',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/default/logout',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/downloads/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/feedback/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/feedback/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/feedback/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/feedback/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/feedback/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/news/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/page/*',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/create',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/delete',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/index',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/update',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/upload',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/page/view',2,NULL,NULL,NULL,1483164471,1483164471),('/backend/photos/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/edit-detail',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/upload-photo',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/photos/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/upload',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/products/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/assignment/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/assignment/assign',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/assignment/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/assignment/revoke',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/assignment/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/default/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/default/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/menu/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/assign',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/remove',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/permission/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/assign',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/remove',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/role/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/assign',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/refresh',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/route/remove',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/create',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/update',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/rule/view',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/*',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/activate',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/change-password',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/delete',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/index',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/login',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/logout',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/request-password-reset',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/reset-password',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/signup',2,NULL,NULL,NULL,1482896720,1482896720),('/backend/rbac/user/view',2,NULL,NULL,NULL,1482896720,1482896720),('/debug/*',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/*',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/db-explain',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/download-mail',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/index',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/toolbar',2,NULL,NULL,NULL,1482977163,1482977163),('/debug/default/view',2,NULL,NULL,NULL,1482977163,1482977163),('/gii/*',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/*',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/action',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/diff',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/index',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/preview',2,NULL,NULL,NULL,1482896720,1482896720),('/gii/default/view',2,NULL,NULL,NULL,1482896720,1482896720),('Administrator',1,'超级管理员',NULL,NULL,1482896582,1482898405),('AdministratorAccess',2,'超级管理员权限',NULL,NULL,1482897169,1482898428),('Visitor',1,'后台参观者','VisitorRule',NULL,1482897794,1482899002),('VisitorAccess',2,'浏览者权限，只读权限','VisitorRule',NULL,1482897866,1482898974);
...
insert  into `category`(`id`,`name`,`pid`,`path`,`type`,`created_at`,`updated_at`) values (1,'产品分类一',0,'',2,1481360463,1481452810),(2,'默认分类',0,'',1,1481367786,1481367944),(3,'新闻分类2',2,'',1,1481372394,1481372772),(4,'产品分类二',0,'',2,1481609361,1481609361),(5,'下载文档',0,'',3,1482155225,1482155225),(6,'企业环境',0,'',4,1482559711,1482559711);
...
insert  into `config`(`id`,`name`,`label`,`value`,`created_at`,`updated_at`) values (2,'contact_us','联系我们','<p>公司: 在北京网络科技</p><p>联系人: 李</p><p>QQ: 739800600</p><p>电话: 1304351</p><p>E-mail: 739800600@qq.com</p><p>地址: 北京市丰台区大红门</p>',1481350005,1482902162),(3,'contact_us_page_id','联系我们','1',1481355647,1483169811);
...
insert  into `content`(`id`,`title`,`type`,`category_id`,`image`,`description`,`keywords`,`status`,`admin_user_id`,`hits`,`created_at`,`updated_at`) values (1,'测试1',1,0,'','测试测试222','',1,0,0,0,1481269292),(7,'新闻2',1,3,'','吃豆腐的房地产','',0,0,0,1481264976,1481379895),(9,'dfdsfadfdsfdsfds',1,0,'','dfsdds','',0,0,0,1481265228,1481265228),(10,'dfsdfds312321的所得税法',1,0,'','的范德萨发的','',0,1,0,1481265362,1481265362),(11,'测试你好',1,0,'','三大市场','',1,1,0,1481265454,1481265454),(13,'sdfdsvds',1,0,'','dsfadsfdsa adfdasfd','',0,1,0,1481265650,1481265650),(14,'dfsdfds312321的所得税法dsfdsf',1,0,'','fdsdsfsdfds','',0,1,0,1481268136,1481268136),(15,'测试测试测试',1,0,'','测试测试222','',0,1,0,1481268506,1481268506),(16,'电风扇的范德萨',1,0,'','东方闪电','',0,1,0,1481268645,1481268645),(17,'ceshi',1,2,'','测试','',1,1,0,1481294417,1482486244),(18,'测试测试',1,0,'','测试3333333','',1,1,0,1481294436,1481294436),(19,'测试测试测试',1,2,'','测试测试','',1,1,0,1481294458,1482120320),(20,'德国代购2016 Marc Jacobs/马克·雅可布 女士撞色皮质直板钱包',2,1,'','<p>德国代购2016 Marc Jacobs/马克·雅可布 女士撞色皮质直板钱包</p>','',1,1,0,1481455753,1482071209),(21,'测试测试',2,1,'/uploads/products-img/img_584d571075916.jpg','测试','',1,1,0,1481463544,1481552670),(22,'测试测试测试',2,1,'/uploads/products-img/img_584d57438ddb0.jpg','测试测试测试','',1,1,0,1481463619,1481463619),(23,'测试产品22222222222222',2,1,'/uploads/products-img/img_584d5d65a0855.jpg','测试产品','',1,1,0,1481465189,1481465189),(24,'飒飒的范德萨范德萨似懂非懂是',2,1,'/uploads/products-img/img_58575c9b83b7b.png','<p>似懂非懂是付的是</p><p><br></p>','',1,1,0,1481465708,1482120751),(25,'美国代购2016 MOTHER 女士磨边牛仔裤',2,1,'/uploads/products-img/img_584eb27571659.jpg','重度磨损和猫须褶皱为这款褪色 MOTHER 牛仔裤带来做旧效果。5 口袋设计。钮扣和拉链门襟。','',1,1,0,1481552501,1481552688),(26,'关于公司考勤制度',3,5,'','<p>关于公司考勤制度</p>','',1,1,0,1482155706,1482157422),(27,'测试',3,5,'','','',0,1,0,1482200020,1482202904),(28,'继承测试',1,2,'','继承测试','',1,1,0,1482291369,1482291661),(29,'产品继承测试',2,1,'/uploads/products-img/img_5859f8c6724c8.jpg','','',1,1,0,1482291398,1482325074),(30,'办公环境',4,6,'','','',1,1,0,1482560413,1482560413),(31,'测试相册',4,6,'','测试','测试',1,1,0,1482654720,1482654720);
...
insert  into `feedback`(`id`,`subject`,`name`,`phone`,`email`,`body`,`created_at`,`updated_at`) values (1,'测试测试','李先生','13240702278','739800600@qq.com','你好你好你好',1481433870,1481433870),(2,'你好','你好','','739800600@qq.com','你好，你好',1481434463,1481434463);
